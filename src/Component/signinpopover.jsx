...
export default function SigninPopover() {
  ...
  const text1 = (
    <div style={{ width: "100%", display: "grid", marginTop:'10px' }}>
      <button  onClick={ () =>{
   navi('/login')
  }} style={{ placeSelf: "center", width: "14em", height: "33px", background: "linear-gradient(to bottom,#f8e3ad,#EEBA37)", border: '1px solid #c89411' }} >
      <a >  Sign in</a>
      </button>
      <span style={{ placeSelf: 'center', fontSize: '0.8em',marginBottom:'10px' }}>New Customer?
        <a style={{ color: "blue",  }} href="/signup">&nbsp;Click here</a>
      </span>
    </div>
  ...
  const text2 = (
    <div style={{ width: "150px", display: "grid" }}>
      <button href='/signup' style={{ placeSelf: "center", width: "8em", height: "36px", marginTop:'10px', background: "linear-gradient(to bottom,#f8e3ad,#EEBA37)", border: '1px solid #c89411' }} >
  ...
  return (
    <>
      ...
      <Popover placement="bottomRight"
        ...
        title={text2}>
          <button style={{ border:'none',background:"none", width: '50%', display: 'flex', justifyContent: 'center', flexDirection: 'column', textAlign: 'center'}}>
