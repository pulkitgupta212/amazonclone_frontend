...
export default function Login1() {
    ...
    let emailphone = state.emailphone.value
    ...
    // }
      ...
      const handleChange = (e) => {
        ...
        setValidation({ ...validation, [key]:  {value,isValid:false}  })
      }
            ...
            <div style={{ height: "auto", paddingBottom: "15px" }}>
                ...
                <div style={{ display: "flex", height: "auto", width: "350px", margin: 'auto', border: '1px solid lightgray', borderRadius: "4px", marginBottom: "10px" }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", width: "80%", margin: "auto", paddingTop: "25px", paddingBottom: "25px", gap: "15px" }}>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: "5px", marginTop: "15px" }}>
                            ...
                            type='password' style={{ height: "2em", border: "1px solid gray" }}></input>
                        </div>
                        <button onClick={handleClick}  style={{ height: "2.5em", background: "linear-gradient(to bottom,#f8e3ad,#EEBA37)", border: "1px solid #c89411" }}>Continue</button>
                ...
                <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
                    <button style={{
                        ...
                        borderRadius: "2px"
                    }} onClick={handleClick}>Create your Amazon Account</button>
